...
public class TagQueryService {
    ...
    public List<String> listTopicTaxonomyTagNames() {
        return jdbcTemplate.queryForList(
                "SELECT name FROM tags WHERE is_topic_taxonomy = 1 ORDER BY name", String.class);
    }
    ...
    public Map<String, Object> topicTaxonomyCoverageSummary() {
        Long topicTagCount = jdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM tags WHERE is_topic_taxonomy = 1", Long.class);
        ...
        Long wordsWithTopicTag = jdbcTemplate.queryForObject(
                """
                        ...
                        WHERE EXISTS (
                          ...
                          WHERE wt.word_id = w.id AND t.is_topic_taxonomy = 1
                        )
                        """,
                Long.class);
