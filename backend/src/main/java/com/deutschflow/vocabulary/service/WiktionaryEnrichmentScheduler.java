...
/**
 * Tự động chạy Wiktionary enrich (IPA + EN/DE gloss) theo lịch.
 * Throughput phụ thuộc {@code ipa-batch.request-delay-ms} × cỡ batch; cursor reset khi IDLE để quét lại từ chưa có data.
 */
@Slf4j
@Component
...
public class WiktionaryEnrichmentScheduler {
    ...
    @Value("${app.vocabulary.wiktionary-scheduler.enabled:false}")
