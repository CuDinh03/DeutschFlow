...
public class OrgController {
     ...
     * tiêu đề khai thêm {@code birthDate[,guardianName,guardianPhone,guardianRelationship]} thì đọc
     * luôn phần dữ liệu chưa thành niên (PR-1B). Cột mới là TÙY CHỌN — tệp ba cột của trung tâm giữ
     * nguyên hành vi cũ; xem {@code RosterColumnLayout}.
     *
     * <p>Ghi danh KHÔNG phải cổng chặn: dòng không khai ngày sinh vẫn nhập bình thường (owner chốt
     * 09/09/2026). Chỉ dòng tự mâu thuẫn — khai tuổi dưới ngưỡng pháp lý mà bỏ trống người giám hộ,
     * ngày sinh sai định dạng hoặc ở tương lai — mới bị từ chối, kèm số dòng và email trong
     * {@code errors}.
     *
