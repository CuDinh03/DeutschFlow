...
public final class WeeklySpeakingDtos {
    ...
    public record WeeklyRubricView(
        ...
        public record Lexis(
                ...
                List<ReplacementSuggestion> replacements_suggested_de_vi
        ) {}

        public record ReplacementSuggestion(
                String from_de,
                String to_de_suggestion,
                String note_vi
        ) {}

        public record Grammar(
                String summary_de,
                List<WeeklySpeakingDtos.WeeklyGrammarErrorHint> errors
        ) {}
    }

    public record WeeklyGrammarErrorHint(
            String error_code,
            String severity,
            Double confidence,
            String wrong_span,
    ...
    // Backwards-compatible aliases for services still using the old names.
