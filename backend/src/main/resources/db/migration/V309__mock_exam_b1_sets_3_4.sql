    ...
    "sections": [
      {
        ...
        "teile": [
          ...
          },
          {
            ...
            "items": [
              {"id":"L3-1","question":"Wie viele Menschen denken laut Text über einen Berufswechsel nach?","options":{"A":"Jede zweite Person","B":"Etwa jede vierte Person","C":"Fast niemand"},"correct":"B","explanation_vi":"etwa jede vierte Person."},
              ...
              {"id":"L3-3","question":"Was raten die Fachleute?","options":{"A":"Sofort kündigen","B":"Den Wechsel gut vorbereiten","C":"Nie den Beruf wechseln"},"correct":"B","explanation_vi":"den Wechsel gut vorzubereiten."},
              {"id":"L3-4","question":"Was sagt der Text über die Kosten einer Umschulung?","options":{"A":"Sie ist immer kostenlos","B":"Die Agentur für Arbeit zahlt manchmal einen Teil","C":"Man muss immer alles selbst zahlen"},"correct":"B","explanation_vi":"In manchen Fällen zahlt die Agentur für Arbeit einen Teil."},
          ...
          },
          {
            ...
            "items": [
              {"id":"L5-1","question":"Was macht man, wenn man zu spät kommt?","options":{"A":"Nach Hause gehen","B":"Sich im Sekretariat melden","C":"Direkt in die Klasse gehen"},"correct":"B","explanation_vi":"Đến muộn thì trình diện văn phòng."},
              {"id":"L5-2","question":"Bis wann muss die schriftliche Entschuldigung da sein?","options":{"A":"Am gleichen Tag","B":"Spätestens am dritten Tag","C":"Innerhalb von zwei Wochen"},"correct":"B","explanation_vi":"spätestens am dritten Tag."},
              {"id":"L5-3","question":"Wann darf man das Handy benutzen?","options":{"A":"Im Unterricht","B":"In den Pausen","C":"Gar nicht"},"correct":"B","explanation_vi":"In den Pausen ist die Nutzung erlaubt."},
              ...
              {"id":"L5-5","question":"Was gilt in den Werkstätten?","options":{"A":"Sicherheitsschuhe sind Pflicht","B":"Essen ist erlaubt","C":"Man braucht keine Aufsicht"},"correct":"A","explanation_vi":"Sicherheitsschuhe sind Pflicht."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-5","audio_script":"Achtung, eine Information für alle Auszubildenden: Der Praxistag am Freitag beginnt ausnahmsweise erst um 9 Uhr, weil die Werkstatt gereinigt wird.","question":"Warum beginnt der Praxistag später?","options":{"A":"Wegen eines Feiertags","B":"Wegen der Reinigung der Werkstatt","C":"Wegen einer Prüfung"},"correct":"B","explanation_vi":"weil die Werkstatt gereinigt wird."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Wo hat Kaan früher gearbeitet?","options":{"A":"Im Lager","B":"Im Büro","C":"In einem Restaurant"},"correct":"A","explanation_vi":"Vorher habe ich im Lager gearbeitet."},
              {"id":"H3-2","question":"Was vermisst Kaan an der alten Arbeit?","options":{"A":"Das schwere Heben","B":"Die Bewegung","C":"Die Arbeitszeiten"},"correct":"B","explanation_vi":"Die Bewegung ja, das Heben nicht."},
              {"id":"H3-3","question":"Wie beschreibt Kaan sein Team?","options":{"A":"Unfreundlich","B":"Hilfsbereit","C":"Zu laut"},"correct":"B","explanation_vi":"Sehr hilfsbereit."},
              {"id":"H3-4","question":"Was stört Kaan an seinem Chef?","options":{"A":"Er gibt selten Rückmeldung","B":"Er kommt zu spät","C":"Er spricht zu leise"},"correct":"A","explanation_vi":"mein Chef gibt selten Rückmeldung."},
    ...
    "sections": [
      {
        ...
        "teile": [
          ...
          },
          {
            ...
            "items": [
              {"id":"L3-1","question":"Wie viel Elektroschrott entsteht pro Person und Jahr?","options":{"A":"Etwa 2 Kilogramm","B":"Etwa 24 Kilogramm","C":"Etwa 240 Kilogramm"},"correct":"B","explanation_vi":"rund 24 Kilogramm pro Person."},
              {"id":"L3-2","question":"Was steht im Text über den Hausmüll?","options":{"A":"Elektroschrott gehört nicht hinein","B":"Elektroschrott darf hinein","C":"Es gibt keine Regeln"},"correct":"A","explanation_vi":"Vứt vào rác sinh hoạt là bị cấm."},
              {"id":"L3-3","question":"Was müssen große Händler tun?","options":{"A":"Alte Geräte kostenlos zurücknehmen","B":"Für alte Geräte bezahlen","C":"Nichts"},"correct":"A","explanation_vi":"große Händler müssen es kostenlos zurücknehmen."},
              {"id":"L3-4","question":"Wie viel Elektroschrott wird richtig entsorgt?","options":{"A":"Fast alles","B":"Etwa die Hälfte","C":"Fast nichts"},"correct":"B","explanation_vi":"nur etwa die Hälfte."},
          ...
          },
          {
            ...
            "items": [
              {"id":"L5-1","question":"Was gehört nicht in die gelbe Tonne?","options":{"A":"Plastikverpackungen","B":"Metallverpackungen","C":"Elektrogeräte"},"correct":"C","explanation_vi":"keine Elektrogeräte."},
              ...
              {"id":"L5-3","question":"Wann darf man Glas einwerfen?","options":{"A":"Rund um die Uhr","B":"Von 7 bis 20 Uhr","C":"Nur sonntags"},"correct":"B","explanation_vi":"Einwurf nur von 7 bis 20 Uhr."},
              {"id":"L5-4","question":"Wie viel Gartenabfall darf man pro Woche kostenlos bringen?","options":{"A":"Einen Kubikmeter","B":"Zehn Kubikmeter","C":"Unbegrenzt"},"correct":"A","explanation_vi":"maximal ein Kubikmeter pro Woche."},
              {"id":"L5-5","question":"Wie lange wartet man zurzeit auf die Sperrmüllabholung?","options":{"A":"Etwa drei Tage","B":"Etwa drei Wochen","C":"Etwa drei Monate"},"correct":"B","explanation_vi":"die Wartezeit beträgt etwa drei Wochen."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-2","audio_script":"A: Was hast du für den alten Kühlschrank bezahlt? B: Nichts, ich habe ihn gebraucht bekommen. Nur der Transport hat 40 Euro gekostet.","question":"Was hat die Person bezahlt?","options":{"A":"40 Euro für den Transport","B":"400 Euro für den Kühlschrank","C":"Gar nichts"},"correct":"A","explanation_vi":"Chỉ tốn 40 euro tiền vận chuyển."},
              {"id":"H1-3","audio_script":"Liebe Fahrgäste, wegen einer Demonstration für den Klimaschutz fahren die Linien 3 und 7 heute Nachmittag über die Ringstraße.","question":"Warum ändern die Linien ihren Weg?","options":{"A":"Wegen eines Unfalls","B":"Wegen einer Demonstration","C":"Wegen Schnee"},"correct":"B","explanation_vi":"wegen einer Demonstration für den Klimaschutz."},
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Seit wann fährt Sara ohne eigenes Auto?","options":{"A":"Seit April","B":"Seit einem Jahr","C":"Seit zwei Wochen"},"correct":"A","explanation_vi":"seit April."},
              {"id":"H3-2","question":"Wie transportiert sie große Einkäufe?","options":{"A":"Mit dem Taxi","B":"Mit Carsharing","C":"Gar nicht"},"correct":"B","explanation_vi":"für große Sachen nutze ich Carsharing."},
              {"id":"H3-3","question":"Wie viel zahlte sie vorher ungefähr im Monat?","options":{"A":"Unter 100 Euro","B":"Etwa 200 Euro","C":"Über 300 Euro"},"correct":"C","explanation_vi":"weit über 300 Euro."},
              {"id":"H3-4","question":"Was findet sie am schwierigsten?","options":{"A":"Den Winter","B":"Den Sommer","C":"Das Einkaufen"},"correct":"A","explanation_vi":"Bei Eis nehme ich die Bahn, đó là phần khó nhất."},
              {"id":"H3-5","question":"Wann würde sie wieder ein Auto kaufen?","options":{"A":"Nie","B":"Wenn sie aufs Land zieht","C":"Nächstes Jahr"},"correct":"B","explanation_vi":"Nur wenn ich aufs Land ziehe."}
            ]
          },
          {
            "teil": 4,
