        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"H1-1","audio_script":"A: Entschuldigung, wo ist die Post? B: Gehen Sie geradeaus und dann links. Die Post ist neben der Apotheke.","question":"Wo ist die Post?","options":{"A":"Neben der Bäckerei","B":"Neben der Apotheke","C":"Neben dem Bahnhof"},"correct":"B","explanation_vi":"Câu trả lời: die Post ist neben der Apotheke (cạnh hiệu thuốc)."},
              ...
              {"id":"H1-4","audio_script":"A: Was kostet das Zimmer pro Nacht? B: Mit Frühstück 45 Euro, ohne Frühstück 38 Euro.","question":"Was kostet das Zimmer mit Frühstück?","options":{"A":"38 Euro","B":"45 Euro","C":"53 Euro"},"correct":"B","explanation_vi":"mit Frühstück = 45 Euro."},
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","audio_script":"Hallo Minh, hier ist Julia. Ich kann heute nicht kommen, ich bin krank. Können wir uns morgen um 17 Uhr treffen?","question":"Warum kommt Julia heute nicht?","options":{"A":"Sie ist krank","B":"Sie muss arbeiten","C":"Sie hat keine Zeit am Abend"},"correct":"A","explanation_vi":"ich bin krank = tôi bị ốm."},
              {"id":"H3-2","audio_script":"Guten Tag, hier ist die Autowerkstatt Meyer. Ihr Auto ist fertig. Sie können es ab morgen früh abholen.","question":"Was soll der Kunde tun?","options":{"A":"Einen neuen Termin machen","B":"Das Auto abholen","C":"Die Werkstatt anrufen"},"correct":"B","explanation_vi":"Xe đã sửa xong, khách đến lấy (abholen)."},
              {"id":"H3-3","audio_script":"Hallo, hier ist Frau Sommer von der Sprachschule. Ihr Kurs beginnt nicht am Montag, sondern erst am Mittwoch.","question":"Wann beginnt der Kurs?","options":{"A":"Am Montag","B":"Am Dienstag","C":"Am Mittwoch"},"correct":"C","explanation_vi":"nicht am Montag, sondern erst am Mittwoch."},
              {"id":"H3-4","audio_script":"Hi Papa, ich bin noch bei Lena. Kannst du mich um acht Uhr am Bahnhof abholen? Danke.","question":"Wo soll der Vater sein Kind abholen?","options":{"A":"Zu Hause bei Lena","B":"Am Bahnhof","C":"In der Schule"},"correct":"B","explanation_vi":"am Bahnhof abholen = đón ở nhà ga."},
              {"id":"H3-5","audio_script":"Guten Abend, hier ist das Restaurant Adler. Ihr Tisch für vier Personen ist am Freitag um 19 Uhr reserviert.","question":"Für wie viele Personen ist der Tisch?","options":{"A":"Für zwei Personen","B":"Für vier Personen","C":"Für fünf Personen"},"correct":"B","explanation_vi":"Tisch für vier Personen = bàn cho 4 người."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-3","audio_script":"A: Was machst du am Wochenende? B: Am Samstag spiele ich Fußball, am Sonntag besuche ich meine Eltern.","question":"Was macht die Person am Sonntag?","options":{"A":"Fußball spielen","B":"Die Eltern besuchen","C":"Arbeiten"},"correct":"B","explanation_vi":"am Sonntag besuche ich meine Eltern."},
          ...
          },
          {
            ...
            "instruction_vi": "Nghe tin nhắn thoại và chọn đáp án đúng",
            "items": [
              {"id":"H3-1","audio_script":"Hallo Anh, hier ist Doktor Weber. Ihre Blutwerte sind in Ordnung. Sie brauchen keinen neuen Termin.","question":"Was sagt der Arzt?","options":{"A":"Die Werte sind in Ordnung","B":"Anh muss ins Krankenhaus","C":"Anh braucht einen neuen Termin"},"correct":"A","explanation_vi":"Ihre Blutwerte sind in Ordnung = kết quả máu ổn."},
              {"id":"H3-2","audio_script":"Guten Tag, hier ist das Schwimmbad Wellenberg. Wegen Reparatur bleibt das Bad bis Freitag geschlossen.","question":"Warum ist das Schwimmbad geschlossen?","options":{"A":"Wegen Ferien","B":"Wegen Reparatur","C":"Wegen eines Festes"},"correct":"B","explanation_vi":"Wegen Reparatur = vì sửa chữa."},
              {"id":"H3-3","audio_script":"Hi Lan, wir treffen uns nicht im Kino, sondern direkt im Café gegenüber. Bis später!","question":"Wo treffen sich die Freunde?","options":{"A":"Im Kino","B":"Zu Hause","C":"Im Café"},"correct":"C","explanation_vi":"nicht im Kino, sondern im Café."},
              {"id":"H3-4","audio_script":"Guten Abend, hier ist die Fahrschule. Ihre Theorieprüfung ist am Montag um 8 Uhr 30, bitte bringen Sie Ihren Pass mit.","question":"Was soll die Person mitbringen?","options":{"A":"Den Pass","B":"Ein Foto","C":"Geld"},"correct":"A","explanation_vi":"bringen Sie Ihren Pass mit = mang hộ chiếu."},
              {"id":"H3-5","audio_script":"Hallo, hier ist Tom. Ich habe zwei Karten für das Konzert am Samstag. Hast du Lust mitzukommen?","question":"Was möchte Tom?","options":{"A":"Karten verkaufen","B":"Zusammen ins Konzert gehen","C":"Am Samstag arbeiten"},"correct":"B","explanation_vi":"Hast du Lust mitzukommen = rủ cùng đi nghe nhạc."}
            ]
          }
        ]
      },
