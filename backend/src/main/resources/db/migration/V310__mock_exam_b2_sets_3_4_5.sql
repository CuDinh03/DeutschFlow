        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"L1-2","question":"Welchen Einwand nennen die Kritiker?","options":{"A":"Die Löhne seien gesunken","B":"Vor allem gut organisierte Betriebe hätten teilgenommen","C":"Die Beschäftigten hätten sich nicht geäußert"},"correct":"B","explanation_vi":"Chỉ những doanh nghiệp vốn đã tổ chức tốt tham gia."},
              {"id":"L1-3","question":"Warum ist das Modell in der Pflege schwierig?","options":{"A":"Weil dort niemand kürzer arbeiten möchte","B":"Weil Personal fehlt und Schichten besetzt werden müssen","C":"Weil die Löhne dort zu hoch sind"},"correct":"B","explanation_vi":"Thiếu nhân lực và phải phủ kín ca."},
              {"id":"L1-4","question":"Was schränkt die Aussagekraft der Studien ein?","options":{"A":"Kurze Zeiträume und freiwillige Teilnahme","B":"Die große Zahl der Teilnehmer","C":"Die staatliche Finanzierung"},"correct":"A","explanation_vi":"die Untersuchungszeiträume waren kurz und die Teilnahme freiwillig."},
              {"id":"L1-5","question":"Wofür plädieren die Wirtschaftsforscher?","options":{"A":"Für ein Gesetz für alle Branchen","B":"Für differenzierte Modelle je nach Branche","C":"Für die Abschaffung des Modells"},"correct":"B","explanation_vi":"differenzierte Modelle statt gesetzlicher Regelung."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Was kritisiert der Kommentar?","options":{"A":"Dass Erreichbarkeit mit Leistung verwechselt wird","B":"Dass zu wenig E-Mails geschrieben werden","C":"Dass Firmen zu viele Pausen erlauben"},"correct":"A","explanation_vi":"Gleichsetzung von Erreichbarkeit und Leistung ist ein Irrtum."},
              ...
              {"id":"L4-3","question":"Welche Rolle spielen Führungskräfte?","options":{"A":"Sie erzeugen durch ihr Verhalten unausgesprochene Erwartungen","B":"Sie haben keinen Einfluss","C":"Sie verbieten das Mailen"},"correct":"A","explanation_vi":"Hành vi của sếp tạo ra kỳ vọng ngầm."},
              {"id":"L4-4","question":"Welchen Vorschlag macht der Text?","options":{"A":"Mehr Überstunden","B":"Feste Zeitfenster für Rückmeldungen","C":"Abschaffung der E-Mail"},"correct":"B","explanation_vi":"feste Zeitfenster für Rückmeldungen."},
              {"id":"L4-5","question":"Welche Haltung vertritt der Autor am Ende?","options":{"A":"Organisierte Ruhe führt zu besserer Arbeit","B":"Ruhe schadet dem Ergebnis","C":"Nur Technik löst das Problem"},"correct":"A","explanation_vi":"Wer Ruhe organisiert, bekommt bessere Arbeit."}
            ]
          },
          {
            "teil": 5,
            ...
            "items": [
              {"id":"L5-1","question":"Wie viele Tage mobiles Arbeiten sind höchstens möglich?","options":{"A":"Zwei Tage","B":"Drei Tage","C":"Fünf Tage"},"correct":"B","explanation_vi":"bis zu drei Tagen pro Woche."},
              ...
              {"id":"L5-3","question":"Bis wann meldet man die Anwesenheitstage?","options":{"A":"Bis Donnerstag der Vorwoche","B":"Am selben Morgen","C":"Bis Monatsende"},"correct":"A","explanation_vi":"bis Donnerstag der Vorwoche."},
              ...
              {"id":"L5-5","question":"Was gilt für vertrauliche Unterlagen?","options":{"A":"Sie dürfen mitgenommen werden","B":"Sie müssen in der Wohnung verschlossen bleiben","C":"Sie werden vernichtet"},"correct":"B","explanation_vi":"Không được mang ra khỏi nhà, phải cất khoá."}
            ]
          }
        ]
      },
      {
        ...
        "teile": [
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Seit wann gilt das Modell im Betrieb von Frau Deniz?","options":{"A":"Seit einem halben Jahr","B":"Seit anderthalb Jahren","C":"Seit fünf Jahren"},"correct":"B","explanation_vi":"seit anderthalb Jahren."},
              ...
              {"id":"H3-3","question":"Was war für Frau Deniz die Voraussetzung des Erfolgs?","options":{"A":"Neue Maschinen","B":"Weniger Besprechungen und aufgeräumte Prozesse","C":"Mehr Werbung"},"correct":"B","explanation_vi":"Halbierte Besprechungen und Prozesse aufgeräumt."},
              {"id":"H3-4","question":"Wie reagierte der Betrieb auf die Kritik der Kundschaft?","options":{"A":"Mit einer Rufbereitschaft","B":"Mit Preissenkungen","C":"Mit einer Rückkehr zur Fünf-Tage-Woche"},"correct":"A","explanation_vi":"Họ lập chế độ trực điện thoại."},
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Wie bewertet die Forschung das Vergessen?","options":{"A":"Als Fehler des Gehirns","B":"Als Teil eines sinnvollen Systems","C":"Als Folge von Schlafmangel"},"correct":"B","explanation_vi":"Vergessen ist kein Defekt, sondern Teil eines Systems."},
              ...
              {"id":"L1-4","question":"Was gilt als besonders wirksam?","options":{"A":"Freies Abrufen ohne Vorlage","B":"Markieren im Text","C":"Abschreiben"},"correct":"A","explanation_vi":"das freie Abrufen ist deutlich wirksamer."},
              {"id":"L1-5","question":"Welche Rolle spielt der Schlaf?","options":{"A":"Er stört die Erinnerung","B":"Er unterstützt die Festigung","C":"Er hat keinen Einfluss"},"correct":"B","explanation_vi":"Schlaf unterstützt die Festigung."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Womit begründet der Autor den Anspruch der Öffentlichkeit?","options":{"A":"Mit der öffentlichen Finanzierung der Forschung","B":"Mit dem Interesse der Verlage","C":"Mit gesetzlichen Fristen"},"correct":"A","explanation_vi":"Nghiên cứu chủ yếu dùng tiền công."},
              {"id":"L4-2","question":"Was kritisiert er an Fachzeitschriften?","options":{"A":"Sie erscheinen zu oft","B":"Sie liegen häufig hinter Bezahlschranken","C":"Sie sind zu kurz"},"correct":"B","explanation_vi":"hinter Bezahlschranken."},
              ...
              {"id":"L4-4","question":"Welchen Fehler nennt er aus der Pandemie?","options":{"A":"Vorläufige Ergebnisse galten als endgültig","B":"Es wurde gar nicht berichtet","C":"Die Forschung wurde eingestellt"},"correct":"A","explanation_vi":"Kết quả sơ bộ bị hiểu là chân lý cuối cùng."},
          ...
          },
          {
            ...
            "items": [
              {"id":"L5-1","question":"Bis wann kann man sich ohne Begründung abmelden?","options":{"A":"Bis 24 Stunden vorher","B":"Bis zehn Tage vorher","C":"Am Prüfungstag"},"correct":"A","explanation_vi":"Abmeldung bis 24 Stunden vorher."},
              ...
              {"id":"L5-4","question":"Was gilt für elektronische Wörterbücher?","options":{"A":"Sie sind immer erlaubt","B":"Sie sind grundsätzlich ausgeschlossen","C":"Sie sind nur mündlich erlaubt"},"correct":"B","explanation_vi":"grundsätzlich ausgeschlossen."},
              {"id":"L5-5","question":"Wie lange hat man Zeit für die Einsicht?","options":{"A":"Vier Wochen nach Bekanntgabe","B":"Sechs Monate","C":"Nur am Tag der Bekanntgabe"},"correct":"A","explanation_vi":"innerhalb von vier Wochen nach Bekanntgabe."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-2","audio_script":"A: Hast du dich für das Seminar entschieden? B: Ich schwanke noch. Der Inhalt reizt mich, aber die Prüfungsleistung ist eine Hausarbeit von 20 Seiten neben dem Job.","question":"Was hält die Person vom Seminar ab?","options":{"A":"Der Umfang der Prüfungsleistung","B":"Der uninteressante Inhalt","C":"Der hohe Preis"},"correct":"A","explanation_vi":"Tiểu luận 20 trang song song với công việc."},
              {"id":"H1-3","audio_script":"Durchsage im Hörsaalgebäude: Die Vorlesung Statistik zwei findet heute im Raum B 3 statt, da die Technik im großen Hörsaal ausgefallen ist. Die Aufzeichnung wird nachgereicht.","question":"Warum wird der Raum gewechselt?","options":{"A":"Wegen Bauarbeiten","B":"Wegen eines Technikausfalls","C":"Wegen zu vieler Studierender"},"correct":"B","explanation_vi":"Kỹ thuật ở giảng đường lớn bị hỏng."},
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Wie beurteilt Frau Roth den Einfluss der Technik?","options":{"A":"Er ist geringer als oft angenommen","B":"Er hat alles verändert","C":"Er ist ausschließlich negativ"},"correct":"A","explanation_vi":"Weniger als viele denken."},
              ...
              {"id":"H3-4","question":"Welches technische Problem nennt Herr Yildiz?","options":{"A":"Zu wenige Bücher","B":"Regelmäßige WLAN-Ausfälle","C":"Fehlende Tafeln"},"correct":"B","explanation_vi":"Bei uns fällt regelmäßig das WLAN aus."},
              {"id":"H3-5","question":"Wie beschreibt Herr Yildiz die Rolle der Eltern?","options":{"A":"Immer hilfreich","B":"Oft hilfreich, manchmal Druck erzeugend","C":"Ohne Bedeutung"},"correct":"B","explanation_vi":"Oft ja, manchmal erzeugen sie Druck."}
            ]
          },
          {
            "teil": 4,
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Was besagt das Leitbild der Fünfzehn-Minuten-Stadt?","options":{"A":"Alles Wichtige ist in einer Viertelstunde erreichbar","B":"Autos fahren höchstens 15 Minuten","C":"Geschäfte öffnen 15 Stunden"},"correct":"A","explanation_vi":"Mọi nhu cầu hằng ngày trong 15 phút đi bộ/xe đạp."},
              {"id":"L1-2","question":"Welches Argument nennen die Befürworter?","options":{"A":"Höhere Mieten","B":"Belebtere Viertel und weniger Verkehr","C":"Mehr Parkplätze"},"correct":"B","explanation_vi":"weniger Verkehr, belebtere Viertel."},
              {"id":"L1-3","question":"Worin sehen Kritiker das Problem?","options":{"A":"In Neubaugebieten fehlt die Grundlage","B":"Innenstädte sind zu klein","C":"Radwege sind zu teuer"},"correct":"A","explanation_vi":"Ở khu xây mới ngoại vi thiếu hạ tầng cơ bản."},
              {"id":"L1-4","question":"Wovon hängt der Erfolg laut Untersuchungen vor allem ab?","options":{"A":"Von hohen Gebühren","B":"Vom Vorhandensein guter Alternativen","C":"Von der Größe der Stadt"},"correct":"B","explanation_vi":"Có lựa chọn thay thế tốt thì tỉ lệ ô tô giảm."},
              {"id":"L1-5","question":"Was raten Verkehrsforscher zur Reihenfolge?","options":{"A":"Zuerst Parkplätze streichen","B":"Zuerst Alternativen bauen, aber den Umbau nicht verschieben","C":"Gar nichts verändern"},"correct":"B","explanation_vi":"Làm hạ tầng trước, nhưng đừng hoãn cải tạo vô thời hạn."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Wie erklärt der Autor die Hitze in Städten?","options":{"A":"Als Folge von Planungsentscheidungen","B":"Als reines Wetterereignis","C":"Als Zufall"},"correct":"A","explanation_vi":"Kết quả của các quyết định quy hoạch nhiều thập kỷ."},
              {"id":"L4-2","question":"Was kritisiert er an Klimaanlagen?","options":{"A":"Sie sind zu leise","B":"Sie kühlen innen und heizen außen","C":"Sie sind verboten"},"correct":"B","explanation_vi":"kühlen innen und heizen außen."},
              {"id":"L4-3","question":"Welche Maßnahme nennt der Text NICHT?","options":{"A":"Trinkbrunnen","B":"Entsiegelung von Höfen","C":"Neue Parkhäuser"},"correct":"C","explanation_vi":"Bài không nhắc tới bãi đỗ xe nhiều tầng."},
              {"id":"L4-4","question":"Warum ist die Pflege entscheidend?","options":{"A":"Weil Bäume ohne Pflege eingehen","B":"Weil Pflege billig ist","C":"Weil Bäume nicht wachsen sollen"},"correct":"A","explanation_vi":"Cây trồng rồi bỏ mặc sẽ chết vào mùa hè thứ ba."},
          ...
          },
          {
            ...
            "items": [
              {"id":"L5-1","question":"Wer bekommt keinen Bewohnerparkausweis?","options":{"A":"Wer bereits einen Dauerstellplatz hat","B":"Wer im Gebiet gemeldet ist","C":"Wer ein kleines Auto fährt"},"correct":"A","explanation_vi":"Có chỗ đỗ cố định khác thì không được cấp."},
              {"id":"L5-2","question":"Wie lange gilt der Ausweis?","options":{"A":"Sechs Monate","B":"Zwölf Monate","C":"Unbegrenzt"},"correct":"B","explanation_vi":"Der Ausweis gilt zwölf Monate."},
              {"id":"L5-3","question":"Was zahlt man für ein Fahrzeug von 5,4 Metern Länge?","options":{"A":"120 Euro","B":"180 Euro","C":"Nichts"},"correct":"B","explanation_vi":"Xe dài trên 5 mét: 180 euro."},
              {"id":"L5-4","question":"Wie lange gilt die Ausnahme für Handwerksbetriebe höchstens?","options":{"A":"Sechs Wochen","B":"Sechs Monate","C":"Zwei Jahre"},"correct":"B","explanation_vi":"längstens für sechs Monate."},
        ...
        "teile": [
          {
            ...
            "instruction_vi": "Nghe các đoạn ngắn và chọn đáp án đúng",
            "items": [
              {"id":"H1-1","audio_script":"Verkehrsmeldung: Auf der A7 zwischen Kreuz Nord und Flughafen staut es sich auf zwölf Kilometern. Grund ist eine gesperrte Fahrspur nach einem liegengebliebenen Lastwagen, die Bergung dauert noch bis etwa 15 Uhr.","question":"Warum staut es sich?","options":{"A":"Wegen eines liegengebliebenen Lastwagens","B":"Wegen Schnee","C":"Wegen einer Demonstration"},"correct":"A","explanation_vi":"Xe tải chết máy khiến một làn bị chặn."},
              {"id":"H1-2","audio_script":"A: Habt ihr euch für das Elektroauto entschieden? B: Noch nicht. Die Reichweite reicht uns, aber in unserer Straße gibt es keine einzige Lademöglichkeit.","question":"Was hält die Familie zurück?","options":{"A":"Die fehlende Lademöglichkeit","B":"Die zu geringe Reichweite","C":"Der hohe Verbrauch"},"correct":"A","explanation_vi":"Không có trạm sạc trong phố."},
              ...
              {"id":"H1-4","audio_script":"A: Wie war die Radtour zur Arbeit im Winter? B: Machbar, solange geräumt wird. An zwei Tagen lag Schnee auf dem Radweg, da bin ich auf die Bahn umgestiegen.","question":"Was hat die Person bei Schnee gemacht?","options":{"A":"Sie ist zu Hause geblieben","B":"Sie ist mit der Bahn gefahren","C":"Sie ist trotzdem geradelt"},"correct":"B","explanation_vi":"bin ich auf die Bahn umgestiegen."},
              {"id":"H1-5","audio_script":"Hinweis der Stadtwerke: Wegen Wartungsarbeiten am Fernwärmenetz kann es am Dienstag zwischen 8 und 14 Uhr zu Unterbrechungen bei der Warmwasserversorgung kommen. Die Heizung bleibt in Betrieb.","question":"Was ist am Dienstag betroffen?","options":{"A":"Die Warmwasserversorgung","B":"Die Stromversorgung","C":"Die Heizung"},"correct":"A","explanation_vi":"Chỉ nước nóng bị gián đoạn, sưởi vẫn chạy."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Wie haben sich die Fahrgastzahlen entwickelt?","options":{"A":"Plus vierzig Prozent","B":"Minus zehn Prozent","C":"Unverändert"},"correct":"A","explanation_vi":"um vierzig Prozent gestiegen."},
              ...
              {"id":"H3-3","question":"Wann ging in der Gemeinde der Autoverkehr zurück?","options":{"A":"Sofort nach der Preissenkung","B":"Erst nach der Verdopplung des Takts","C":"Gar nicht"},"correct":"B","explanation_vi":"erst, nachdem wir den Takt verdoppelt haben."},
              ...
              {"id":"H3-5","question":"Welche Grenze sieht Herr Neumann?","options":{"A":"Das Modell trägt nicht in dünn besiedelten Regionen","B":"Es gibt zu viele Busse","C":"Die Fahrgäste zahlen zu viel"},"correct":"A","explanation_vi":"In dünn besiedelten Regionen fehlt die Basis."}
            ]
          },
          {
            "teil": 4,
