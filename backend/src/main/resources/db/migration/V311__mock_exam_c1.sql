        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"L1-2","question":"Wie wird ein Befund ohne Effekt im Wissenschaftsbetrieb bewertet?","options":{"A":"Als Grund für eine Auszeichnung","B":"Als besonders wertvoll","C":"Als Misserfolg, obwohl er informativ ist"},"correct":"C","explanation_vi":"gilt als Misserfolg, obwohl er den Erkenntnisstand präzisiert."},
              ...
              {"id":"L1-5","question":"Wie geht der Autor mit dem Einwand der Skeptiker um?","options":{"A":"Er übernimmt ihn ohne Einschränkung","B":"Er lehnt ihn vollständig ab","C":"Er hält ihn für berechtigt, aber nicht für entkräftend"},"correct":"C","explanation_vi":"Dieser Einwand verdient Gehör, entkräftet die Kritik aber nicht."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Woran lässt sich laut Text der Unterschied ablesen?","options":{"A":"An der Zielsetzung und der Bereitschaft, sich widerlegen zu lassen","B":"An der Lautstärke der Debatte","C":"An der Zahl der Publikationen"},"correct":"A","explanation_vi":"Ai sẵn sàng bị bác bỏ mới là hoài nghi khoa học."},
              {"id":"L4-2","question":"Was kennzeichnet die Produktion von Zweifel?","options":{"A":"Es werden neue Daten erhoben","B":"Das Argument wird gewechselt, sobald es widerlegt ist","C":"Die Methode wird offengelegt"},"correct":"B","explanation_vi":"wechselt das Argument, sobald es widerlegt ist."},
              {"id":"L4-3","question":"Warum ist die Unterscheidung für die Öffentlichkeit schwierig?","options":{"A":"Weil es keine Studien gibt","B":"Weil beide Seiten dieselbe Sprache benutzen","C":"Weil Medien nicht berichten"},"correct":"B","explanation_vi":"beide Seiten benutzen dieselbe Sprache."},
              ...
              {"id":"L4-5","question":"Welche Haltung empfiehlt der Text am Ende?","options":{"A":"Kritik ignorieren","B":"Kritik nach der Absicht beurteilen","C":"Kritik nach ihren Gründen beurteilen"},"correct":"C","explanation_vi":"nicht von der Absicht her, sondern von ihren Gründen."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-3","audio_script":"Hinweis der Bibliothek: Die Datenbank ist ab Montag nur noch über den Campuszugang erreichbar. Wer von zu Hause arbeitet, benötigt künftig den Fernzugriff, der einmalig freigeschaltet werden muss.","question":"Was ändert sich für Nutzer im Homeoffice?","options":{"A":"Sie verlieren den Zugang vollständig","B":"Sie brauchen einen freigeschalteten Fernzugriff","C":"Sie müssen eine Gebühr zahlen"},"correct":"B","explanation_vi":"Cần kích hoạt truy cập từ xa một lần."},
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Was hat die Arbeitsgruppe geändert?","options":{"A":"Das Forschungsthema","B":"Die Arbeitszeiten","C":"Die Regeln der Autorenschaft"},"correct":"C","explanation_vi":"wir haben die Autorenschaft neu geregelt."},
              {"id":"H3-2","question":"Wie beschreibt Herr Amini die Anfangsphase?","options":{"A":"Alle lehnten die Regeln ab","B":"Es gab keinerlei Konflikte","C":"Es gab mehr Streit über vorher Unausgesprochenes"},"correct":"C","explanation_vi":"mehr gestritten über Dinge, die vorher unausgesprochen blieben."},
              {"id":"H3-3","question":"Wie wirkte sich die Änderung kurzfristig aus?","options":{"A":"Nichts änderte sich","B":"Die Gruppe wurde schneller","C":"Die Gruppe wurde langsamer"},"correct":"C","explanation_vi":"Kurzfristig sind wir langsamer geworden."},
              {"id":"H3-4","question":"Welchen langfristigen Vorteil nennt Frau Kern?","options":{"A":"Mehr Publikationen","B":"Weniger Streit bei Beförderungen","C":"Höhere Drittmittel"},"correct":"B","explanation_vi":"weniger Streit bei Beförderungen."},
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Worin sieht der Text die begriffliche Unschärfe der Debatte?","options":{"A":"Es fehlen Statistiken","B":"Berufe werden diskutiert, automatisiert werden Aufgaben","C":"Die Technik ist unbekannt"},"correct":"B","explanation_vi":"Diskutiert werden Berufe, automatisiert werden Aufgaben."},
              {"id":"L1-2","question":"Wie verändert sich das Profil der Buchhalterin?","options":{"A":"Es verschwindet","B":"Es bleibt identisch","C":"Es verschiebt sich zu Prüfung und Ausnahmefällen"},"correct":"C","explanation_vi":"Richtung Prüfung, Kommunikation und Ausnahmefälle."},
              {"id":"L1-3","question":"Welche Gruppe ist laut Text besonders betroffen?","options":{"A":"Hochqualifizierte","B":"Nur Ungelernte","C":"Mittlere Qualifikationen mit hohem Routineanteil"},"correct":"C","explanation_vi":"mittlere Qualifikationen mit hohem Routineanteil."},
              ...
              {"id":"L1-5","question":"Warum überschätzen die zitierten Prognosen den Effekt?","options":{"A":"Weil sie nur ein Land betrachten","B":"Weil sie zu neu sind","C":"Weil sie auf Berufsklassifikationen beruhen"},"correct":"C","explanation_vi":"beruht auf Berufsklassifikationen."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              ...
              {"id":"L4-3","question":"Was wirft er der Rekrutierungspraxis vor?","options":{"A":"Sie antwortet zu schnell","B":"Sie stellt zu wenige Anforderungen","C":"Sie verwechselt Passung mit Perfektion"},"correct":"C","explanation_vi":"Passung mit Perfektion verwechselt."},
              {"id":"L4-4","question":"Welche Folge hat eine späte Rückmeldung?","options":{"A":"Die Stellen werden gestrichen","B":"Bewerber warten geduldig","C":"Bewerber gehen zur Konkurrenz"},"correct":"C","explanation_vi":"verliert Bewerber an schnellere Konkurrenten."},
        ...
        "teile": [
          {
            ...
            "instruction_vi": "Nghe các đoạn ngắn và chọn đáp án đúng",
            "items": [
              {"id":"H1-1","audio_script":"Aus einer Betriebsversammlung: Die Geschäftsführung hält fest, dass die Einführung des Systems nicht mit Personalabbau verbunden ist. Zugleich weisen wir darauf hin, dass frei werdende Stellen im Bereich Datenerfassung zunächst nicht neu besetzt werden.","question":"Was folgt aus der Ansage?","options":{"A":"Es gibt Kündigungen","B":"Die Einführung wird gestoppt","C":"Frei werdende Stellen bleiben zunächst unbesetzt"},"correct":"C","explanation_vi":"Không sa thải nhưng không tuyển bù."},
          ...
          },
          {
            ...
            "items": [
              ...
              {"id":"H3-4","question":"Warum nennt Herr Ferreira den Wechsel ein Privileg?","options":{"A":"Weil er selten angeboten wird","B":"Weil er teuer ist und nicht alle ihn tragen können","C":"Weil er nur für Junge gilt"},"correct":"B","explanation_vi":"Người gánh tiền nhà và con cái một mình không kham nổi."},
              {"id":"H3-5","question":"Was wünscht sich Frau Hübner zusätzlich?","options":{"A":"Kürzere Ausbildungen","B":"Weniger Misstrauen gegenüber späten Wechseln","C":"Höhere Prüfungsgebühren"},"correct":"B","explanation_vi":"Bà bị hỏi vì sao gần 50 tuổi còn bắt đầu lại."}
            ]
          },
          {
            "teil": 4,
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Was setzt der Wunsch nach jüngerem Publikum laut Text voraus?","options":{"A":"Dass das Programm gleich bleibt","B":"Dass die Preise steigen","C":"Dass sich das Haus selbst verändert"},"correct":"C","explanation_vi":"Nhóm khán giả mới sẽ thay đổi chính nhà hát."},
              {"id":"L1-2","question":"Was ist laut Besucherforschung seltener die Hürde als angenommen?","options":{"A":"Die Uhrzeit","B":"Der Preis","C":"Die Entfernung"},"correct":"B","explanation_vi":"der Preis ist seltener die Hürde als angenommen."},
              ...
              {"id":"L1-4","question":"Welcher Faktor wird als besonders wirksam genannt?","options":{"A":"Die Auswahl der Stücke","B":"Das Personal an der Kasse","C":"Die Größe des Saals"},"correct":"B","explanation_vi":"Bindung hängt stärker vom Personal an der Kasse ab."},
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Wie ordnet der Autor die Auswahl durch Algorithmen historisch ein?","options":{"A":"Früher gab es keine Auswahl","B":"Auswahl gab es auch früher, aber sie war angreifbar","C":"Algorithmen wählen nicht aus"},"correct":"B","explanation_vi":"Trước đây cũng có chọn lọc, nhưng gắn với con người nên phê phán được."},
              {"id":"L4-2","question":"Worin liegt laut Text das eigentlich Neue?","options":{"A":"In der Unsichtbarkeit des Filterns","B":"In der Geschwindigkeit","C":"In der Zahl der Titel"},"correct":"A","explanation_vi":"weniger im Filtern als in seiner Unsichtbarkeit."},
              ...
              {"id":"L4-4","question":"Warum genügen Vielfaltsquoten laut Text nicht?","options":{"A":"Weil sie zu teuer sind","B":"Weil die Oberfläche trotzdem wenige Titel zeigt","C":"Weil niemand sie kontrolliert"},"correct":"B","explanation_vi":"Có nhiều lựa chọn mà giao diện chỉ hiện ba tựa thì vô ích."},
        ...
        "teile": [
          {
            ...
            "instruction_vi": "Nghe các đoạn ngắn và chọn đáp án đúng",
            "items": [
              {"id":"H1-1","audio_script":"Aus einer Ansage im Theater: Wegen einer kurzfristigen Erkrankung übernimmt heute Abend die Zweitbesetzung die Hauptrolle. Wer deshalb nicht bleiben möchte, kann die Karte an der Kasse zurückgeben, allerdings nur bis Vorstellungsbeginn.","question":"Was gilt für die Rückgabe?","options":{"A":"Bis zum Folgetag","B":"Bis zur Pause","C":"Nur bis Vorstellungsbeginn"},"correct":"C","explanation_vi":"nur bis Vorstellungsbeginn."},
              {"id":"H1-2","audio_script":"A: Wie fandest du die Ausstellung? B: Die Werke ja, die Hängung nein. Auf drei Metern Abstand kann man diese Bilder nicht wirken lassen, das ist eine Frage des Respekts vor der Arbeit.","question":"Was kritisiert die zweite Person?","options":{"A":"Die Auswahl der Werke","B":"Den Eintrittspreis","C":"Die Art der Präsentation"},"correct":"C","explanation_vi":"Cách treo tranh quá sát nhau."},
              {"id":"H1-3","audio_script":"Hinweis eines Verlags: Die Lesung findet nicht in der Buchhandlung, sondern im Saal der Volkshochschule statt. Der Grund ist die unerwartet hohe Zahl der Anmeldungen. Bereits gekaufte Karten behalten ihre Gültigkeit.","question":"Warum wird der Ort gewechselt?","options":{"A":"Wegen der hohen Zahl der Anmeldungen","B":"Wegen zu weniger Anmeldungen","C":"Wegen einer Renovierung"},"correct":"A","explanation_vi":"unerwartet hohe Zahl der Anmeldungen."},
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Was hat dem Kino laut Frau Bruns geholfen?","options":{"A":"Ein Mitgliedschaftsmodell","B":"Neue Technik","C":"Höhere Ticketpreise"},"correct":"A","explanation_vi":"Nicht die Technik, sondern die Mitgliedschaft."},
              {"id":"H3-2","question":"Was beobachtet Herr Lehmann?","options":{"A":"Alle Kinos schließen","B":"Häuser mit Bindung überstehen Krisen besser","C":"Ticketverkauf ist am stabilsten"},"correct":"B","explanation_vi":"Häuser mit Bindung überstehen Krisen."},
              {"id":"H3-3","question":"Worin sieht Frau Bruns das eigentliche Problem?","options":{"A":"In den Streaminganbietern allgemein","B":"In den kurzen Auswertungsfenstern","C":"In den Filmpreisen"},"correct":"B","explanation_vi":"Phim lên nền tảng chỉ sau sáu tuần."},
              {"id":"H3-4","question":"Wie beurteilt Herr Lehmann Plattformen für kleine Filme?","options":{"A":"Als bedeutungslos","B":"Als einzige Chance, gesehen zu werden","C":"Als schädlich"},"correct":"B","explanation_vi":"die einzige Chance, überhaupt gesehen zu werden."},
              {"id":"H3-5","question":"Was wirft Frau Bruns Herrn Lehmann am Ende vor?","options":{"A":"Dass er die Zahlen nicht kennt","B":"Dass er das Kino nie besucht","C":"Dass er selbst an den Plattformen verdient"},"correct":"C","explanation_vi":"Sie verdienen daran mit."}
            ]
          },
          {
            "teil": 4,
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Welche Verwechslung kritisiert der Text?","options":{"A":"Schule und Betrieb","B":"Ursache und Wirkung bei Sprache und Arbeit","C":"Sprache und Dialekt"},"correct":"B","explanation_vi":"Bài phê phán việc lẫn lộn nhân với quả."},
              {"id":"L1-2","question":"Welche Wirkung hat Arbeit laut Text auf den Spracherwerb?","options":{"A":"Sie verlangsamt ihn","B":"Sie hat keinen Einfluss","C":"Sie beschleunigt ihn"},"correct":"C","explanation_vi":"Wer arbeitet, lernt schneller."},
              ...
              {"id":"L1-4","question":"Unter welcher Bedingung wirkt Sprachbegleitung im Betrieb gut?","options":{"A":"Wenn sie freiwillig ist","B":"Wenn sie nicht als Belohnung vergeben wird","C":"Wenn sie abends stattfindet"},"correct":"B","explanation_vi":"nicht als Belohnung für Wohlverhalten."},
              {"id":"L1-5","question":"Wie antwortet der Text auf die Sorge sinkender Standards?","options":{"A":"Standards sind unwichtig","B":"Standards steigen nicht durch Verengung des Zugangs","C":"Standards sollten abgeschafft werden"},"correct":"B","explanation_vi":"Câu cuối bài trả lời chính xác điều này."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Was kritisiert der Autor am Begriff Integration?","options":{"A":"Er ist zu neu","B":"Er suggeriert einen abgeschlossenen Zustand","C":"Er wird nur in Behörden verwendet"},"correct":"B","explanation_vi":"suggeriert einen Zustand, den man erreicht."},
              ...
              {"id":"L4-3","question":"Was fehlt laut Autor in der Debatte?","options":{"A":"Die Sprachkurse","B":"Die Seite der Aufnahmegesellschaft","C":"Die Statistik"},"correct":"B","explanation_vi":"selten von der Seite der Aufnahmegesellschaft die Rede."},
              {"id":"L4-4","question":"Wie steht der Autor zu Erwartungen an Zugewanderte?","options":{"A":"Er hält sie für unwichtig","B":"Er lehnt sie ab","C":"Er hält sie für legitim"},"correct":"C","explanation_vi":"Nichts davon spricht gegen Erwartungen."},
        ...
        "teile": [
          ...
          },
          {
            ...
            "items": [
              ...
              {"id":"H3-3","question":"Wer hat Herrn Nazari konkret geholfen?","options":{"A":"Ein staatliches Programm","B":"Eine Bank","C":"Ein Meister, der ihn hospitieren ließ"},"correct":"C","explanation_vi":"kein Programm, sondern ein Meister."},
        ...
        "teile": [
          {
            ...
            "items": [
              {"id":"L1-1","question":"Warum hält der Text die Ausgangsfrage für unfruchtbar?","options":{"A":"Weil sie zu alt ist","B":"Weil sie eine Alternative unterstellt, wo eine Wechselwirkung besteht","C":"Weil sie unbeantwortbar ist"},"correct":"B","explanation_vi":"Câu thứ hai của bài nêu rõ điều này."},
              ...
              {"id":"L1-3","question":"Welcher überraschende Befund wird genannt?","options":{"A":"Politische Maßnahmen sind unbeliebt","B":"Appelle erhöhen die Zustimmung stark","C":"Betonung persönlicher Verantwortung senkt die Zustimmung zu politischen Maßnahmen"},"correct":"C","explanation_vi":"Nhấn mạnh trách nhiệm cá nhân làm giảm ủng hộ chính sách."},
              {"id":"L1-4","question":"Welche Wirkung individuellen Verhaltens hält der Text für belegt?","options":{"A":"Verhalten ist wirkungslos","B":"Frühe Anwender senken Kosten neuer Technologien","C":"Verhalten ersetzt Regeln"},"correct":"B","explanation_vi":"dieser Effekt ist gut belegt."},
              {"id":"L1-5","question":"Wie soll individuelles Verhalten laut Text verstanden werden?","options":{"A":"Als Ersatz für Regeln","B":"Als reine Privatsache","C":"Als Vorwegnahme einer Regel"},"correct":"C","explanation_vi":"als Vorwegnahme einer Regel, nicht als deren Ersatz."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"L4-1","question":"Warum überzeugt Verzicht als Leitidee laut Autor nicht?","options":{"A":"Weil ihn niemand versteht","B":"Weil er zu teuer ist","C":"Weil er ungleich verteilt ist"},"correct":"C","explanation_vi":"Verzicht ist ungleich verteilt."},
              {"id":"L4-2","question":"Welchen Eindruck erzeugt eine Politik, die nicht unterscheidet?","options":{"A":"Es gehe um Statistik","B":"Es gehe nur um Technik","C":"Es gehe um Moral statt um Verhältnisse"},"correct":"C","explanation_vi":"Câu trong bài nói đúng như vậy."},
              ...
              {"id":"L4-4","question":"Was betont er zur Reihenfolge?","options":{"A":"Beides gleichzeitig ist unmöglich","B":"Erst das Verbot, dann die Alternative","C":"Erst die bessere Option, dann wird die schlechtere entbehrlich"},"correct":"C","explanation_vi":"Erst muss die bessere Option existieren."},
              {"id":"L4-5","question":"Wovor warnt der Autor am Ende?","options":{"A":"Vor zu schnellen Verbesserungen","B":"Vor jeder Diskussion","C":"Vor dem Leugnen tatsächlicher Kosten"},"correct":"C","explanation_vi":"wer das leugnet, verliert die Glaubwürdigkeit."}
            ]
          }
        ]
      },
        ...
        "teile": [
          {
            ...
            "items": [
              ...
              {"id":"H1-3","audio_script":"Hinweis eines Betriebs: Wir liefern ab Januar nur noch in Mehrwegbehältern. Die Behälter bleiben unser Eigentum und werden bei der nächsten Lieferung getauscht, ein Pfand wird nicht erhoben.","question":"Was gilt für die Behälter?","options":{"A":"Sie müssen gekauft werden","B":"Sie werden getauscht, ohne Pfand","C":"Sie werden entsorgt"},"correct":"B","explanation_vi":"Đổi khi giao lần sau, không thu tiền cọc."},
              {"id":"H1-4","audio_script":"A: Was hältst du von der neuen Kennzeichnung? B: Grundsätzlich viel. Nur nützt sie wenig, solange sie freiwillig ist. Wer schlecht abschneidet, druckt sie einfach nicht auf.","question":"Was kritisiert die zweite Person?","options":{"A":"Die Kosten","B":"Die Farben der Kennzeichnung","C":"Die Freiwilligkeit der Kennzeichnung"},"correct":"C","explanation_vi":"Ai điểm kém thì không in nhãn."},
              {"id":"H1-5","audio_script":"Aus einer Ratssitzung: Der Antrag wird zurückgestellt. Nicht, weil er inhaltlich abgelehnt wird, sondern weil die Kostenschätzung fehlt. Ohne Zahlen können wir keinen Beschluss fassen.","question":"Warum wird der Antrag zurückgestellt?","options":{"A":"Weil er inhaltlich abgelehnt wird","B":"Weil die Sitzung zu lange dauert","C":"Weil die Kostenschätzung fehlt"},"correct":"C","explanation_vi":"weil die Kostenschätzung fehlt."}
            ]
          },
          {
            "teil": 2,
          ...
          },
          {
            ...
            "items": [
              {"id":"H3-1","question":"Wie viele Haushalte sind angeschlossen?","options":{"A":"Achtzig Prozent","B":"Etwa die Hälfte","C":"Alle"},"correct":"A","explanation_vi":"achtzig Prozent der Haushalte."},
              {"id":"H3-2","question":"Womit hat Frau Steger überzeugt?","options":{"A":"Mit Klimaargumenten","B":"Mit offengelegter Kalkulation inklusive Risiken","C":"Mit Werbung"},"correct":"B","explanation_vi":"die Kalkulation offengelegt, inklusive der Risiken."},
              ...
              {"id":"H3-4","question":"Was war das größte Hindernis?","options":{"A":"Die Finanzierung","B":"Die Technik","C":"Die Genehmigung"},"correct":"A","explanation_vi":"Die Finanzierung, ehrlich gesagt."},
              {"id":"H3-5","question":"Wofür plädiert Herr Prahl?","options":{"A":"Für den Verzicht auf Genossenschaften","B":"Für höhere Preise","C":"Für kommunale Bürgschaften"},"correct":"C","explanation_vi":"ich plädiere für Bürgschaften der Kommune."}
            ]
          },
          {
            "teil": 4,
