...
class StudentAssignmentDtoTest {
    ...
    void finalGrade_isPublished(String status) {
        StudentAssignmentDto dto = StudentAssignmentDto.forStudent(row(status), classAssignment());
    ...
    void nullClassAssignment_usesDefaults() {
        StudentAssignmentDto dto = StudentAssignmentDto.forStudent(row(AssignmentStatus.EVALUATED), null);
