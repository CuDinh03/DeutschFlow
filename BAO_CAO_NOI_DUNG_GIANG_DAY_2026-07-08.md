...
| B3. Selbstevaluation "Tôi có thể…" | Checklist can-do cuối bài cho HV tự đánh giá | Self-assessment; bản đồ tiến độ CEFR = tổng can-do đạt | TB | B1 + student sync |
| B4. Competency ledger | Mỗi HV × can-do: not-started/in-progress/mastered, cập nhật tự động từ điểm + SRS | Nền cho báo cáo & remediation | Cao | B1 + AI grading + SRS |
...
| `student_competency` | Bảng mới `(studentId, canDoId, status, updatedAt)` | Competency ledger |
...
- Competency ledger (B4) + Selbstevaluation (B3).
