// Schneider — RN port of the web bespoke SVG character (1:1). Pure react-native-svg +
...
export function SchneiderCharacter({ expression = 'neutral', isTalking = false, size, paused = false }: Props) {
