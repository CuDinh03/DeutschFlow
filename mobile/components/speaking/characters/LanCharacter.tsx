// Lan — RN port of the web bespoke SVG character (1:1). Pure react-native-svg +
...
export function LanCharacter({ expression = 'idle', isTalking = false, size, paused = false }: Props) {
