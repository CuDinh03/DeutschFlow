...
- 🔄 **EAS preview build ĐANG CHẠY** — build `30ec9041-7b63-4fb3-9908-3dc4ef46c46a` (simulator), xác nhận release + tất cả thay đổi. Xem status: `npx eas-cli build:view 30ec9041-...` hoặc https://expo.dev/accounts/cudinh3502/projects/deutschflow/builds/30ec9041-7b63-4fb3-9908-3dc4ef46c46a
- ⏳ Next = chờ EAS preview xanh → (👤) APNs key + Sentry re-add + 3 giá trị `eas.json submit` + Privacy/Support URL → Pha 5 production build/TestFlight/submit. + device QA cho audio.
