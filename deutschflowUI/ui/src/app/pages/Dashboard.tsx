...
const recommendedLessons = [
  {
    ...
    rating: 4.9,
    image:
      "https://images.unsplash.com/photo-1761139844010-442a8b0f5c4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxHZXJtYW4lMjBjaXR5JTIwYXJjaGl0ZWN0dXJlJTIwdHJhdmVsfGVufDF8fHx8MTc3NTk3MTgzMHww&ixlib=rb-4.1.0&q=80&w=400",
    tag: "Beliebt",
  ...
  },
  {
    ...
    rating: 4.7,
    image:
      "https://images.unsplash.com/photo-1758270704787-615782711641?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYW5ndWFnZSUyMGxlYXJuaW5nJTIwY29udmVyc2F0aW9uJTIwY2xhc3Nyb29tfGVufDF8fHx8MTc3NjA3NjE1OHww&ixlib=rb-4.1.0&q=80&w=400",
    tag: "Neu",
  ...
  },
  {
    ...
    rating: 4.8,
    image:
      "https://images.unsplash.com/photo-1750809411153-eb949a8fd9b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2ZmZWUlMjBzaG9wJTIwcmVhZGluZyUyMGJvb2slMjBzdHVkeXxlbnwxfHx8fDE3NzYwNzYxNTh8MA&ixlib=rb-4.1.0&q=80&w=400",
    tag: "Empfohlen",
  ...
  },
  {
    ...
    rating: 4.6,
    image:
      "https://images.unsplash.com/photo-1627667049482-dd134b1f6366?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaWNyb3Bob25lJTIwcG9kY2FzdCUyMHNwZWFraW5nJTIwcmVjb3JkaW5nfGVufDF8fHx8MTc3NjA3NjE1OXww&ixlib=rb-4.1.0&q=80&w=400",
    tag: "Fortgeschritten",
    ...
    <div className="flex h-screen bg-[#F5F7FA] overflow-hidden">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
          ...
          <button
            onClick={() => { navigate("/roadmap"); setSidebarOpen(false); }}
          ...
          <button
            onClick={() => { navigate("/vocabulary"); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-[12px] text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 text-left"
          >
          ...
          <button
            onClick={() => { navigate("/speaking"); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-[12px] text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 text-left"
          >
            <Mic size={19} className="flex-shrink-0" />
            <span className="font-medium text-sm">KI Sprechen</span>
            <span className="ml-auto text-[10px] font-bold bg-[#22D3EE]/20 text-[#22D3EE] px-1.5 py-0.5 rounded-full border border-[#22D3EE]/30">AI</span>
          </button>

          <button
            onClick={() => { navigate("/flashcards"); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-[12px] text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 text-left"
          >
            <Layers size={19} className="flex-shrink-0" />
            <span className="font-medium text-sm">Karteikarten</span>
          </button>

          <button
            onClick={() => { navigate("/swipe"); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-[12px] text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 text-left"
          >
            <Repeat2 size={19} className="flex-shrink-0" />
            <span className="font-medium text-sm">Wischen lernen</span>
          </button>

          <button
            onClick={() => { navigate("/game"); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-[12px] text-white/70 hover:bg-white/10 hover:text-white transition-all duration-200 text-left"
          >
