...
export type PersonaGroup = 'it' | 'verkauf' | 'medizin' | 'maschinenbau' | 'service' | 'medien' | 'special';
...
export const PERSONA_TOKENS: Record<PersonaId, PersonaToken> = {
  ...
  hannie: {
    ...
    group: "medien",
    accent: "#F97316", glow: "rgba(249,115,22,0.4)", bubble: "#431407",
    border: "rgba(249,115,22,0.25)", bg: "rgba(249,115,22,0.08)", tagBg: "rgba(249,115,22,0.15)",
    ctaFrom: "#EA580C", ctaTo: "#F97316", ctaShadow: "0 4px 0 #9A3412, 0 8px 24px rgba(249,115,22,0.35)",
    supportsInterview: true, supportsLesson: false,
    interviewPositions: [
    ...
    replies: [
      "Hey hey! Ich bin Hannie! Bereit für dein Deutsch-Abenteuer? 🎤",
      "Wow, das war super! Du klingst schon wie ein echter Profi! ✨",
      "Mega! Weiter so — du wirst immer besser! 🎉",
    ],
  },
