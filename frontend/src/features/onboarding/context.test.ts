/**
 * Đợt 5 (17/09/2026) — `GET /onboarding/context` phía web + bộ mặc định của bản rút gọn.
 * Mobile chạy cùng bộ ca trên `mobile/lib/onboardingContext.ts`.
 */
...
describe('fetchOnboardingContext', () => {
  ...
  it.each([
    ...
    getMock.mockImplementation(async () => { throw err })
...
describe('liteProfilePayload', () => {
  it('đủ trường bắt buộc của POST /onboarding/profile; mục tiêu/lĩnh vực/kỳ thi để trống cố ý', () => {
