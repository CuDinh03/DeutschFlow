...
import VocabularyImageReviewPanel from './components/VocabularyImageReviewPanel'
import VocabularyBatchImagePanel from './components/VocabularyBatchImagePanel'
import {
  AutoTagPanel,
  GlosbeViPanel,
  LlmViPanel,
  ...
  return (
    <AdminShell title="Quản lý từ vựng" subtitle={`${total.toLocaleString()} từ trong database`} activeNav="vocabulary">
      <div className="space-y-5">
        ...
        {/* Unsplash review */}
        <VocabularyImageReviewPanel
          selectedWord={activeWord}
          onOpenEdit={(word) => setActiveWord(word)}
        />
