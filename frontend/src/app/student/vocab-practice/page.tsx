...
export default function VocabPracticePage() {
  ...
  }, [buildWordsParams, scrollSetupStartIntoView, selCefr, selTag, trackFeatureAction, t])
            ...
            <motion.div key="practice" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              ...
              <AnimatePresence mode="wait">
                <motion.div key={idx}
                  ...
                  {words[idx].imageUrl ? (
                    <div className="mx-auto mb-4 w-full max-w-xs rounded-2xl overflow-hidden border border-white/10">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={words[idx].imageUrl}
                        alt=""
