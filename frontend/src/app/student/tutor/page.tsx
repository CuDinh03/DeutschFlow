...
const BADGES = [
  { icon: Code2,         label: "10+ Jahre Dev",    bg: "#EBF2FA", color: "#121212" },
    ...
    >
      <div className="max-w-[430px] mx-auto pb-10">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(160deg, #121212 0%, #00498C 60%, #1A6FAE 100%)",
        ...
        >
          ...
          <div className="flex items-end gap-0 px-6 pt-8 pb-0">
            ...
            <div className="flex-1 pb-6">
              ...
              >
                <span
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black mb-3 bg-[#FFCD00] text-[#121212]"
                >
                  ✦ KI-TUTOR
                </span>
        ...
        <div className="mt-8">
          <motion.button
            className="w-full py-4 rounded-[16px] font-black text-base flex items-center justify-center gap-2 text-[#FFCD00] shadow-xl"
            style={{
              background: "linear-gradient(135deg, #121212, #0052A0)",
              boxShadow: "0 4px 0 0 #001F3D",
            }}
            whileTap={{ scale: 0.97, y: 4, boxShadow: "0 0px 0 0 #001F3D" }}
            onClick={() => router.push("/student/roadmap")}
          >
            <Zap size={18} fill="#FFCD00" />
