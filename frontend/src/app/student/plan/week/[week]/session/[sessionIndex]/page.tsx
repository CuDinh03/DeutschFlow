...
export default function SessionDetailPage() {
  ...
  if (loadError) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="section-card max-w-md w-full text-center space-y-3">
  ...
  return (
    ...
    >
      ...
      />
      <div className="page-container max-w-4xl px-4 sm:px-6 py-8">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#00305E]">{t('weekSession', { week: detail.week, session: detail.sessionIndex })}</h1>
            <p className="text-slate-500 mt-1">{t('meta', { type: detail.type, minutes: detail.minutes, difficulty: detail.difficulty })}</p>
          </div>
          <div className="flex items-center gap-2">
            <button className="btn-outline btn-md border-[#E2E8F0] bg-white" onClick={() => router.push('/student/plan')}>
              {t('backPlan')}
            </button>
          </div>
        </div>

        <div className="section-card rounded-[20px] p-6 mb-6 border-2 border-[#E2E8F0] shadow-[0_4px_20px_rgba(0,48,94,0.08)]">
