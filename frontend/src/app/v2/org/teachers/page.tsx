              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                {teachers.map((tc) => (
                  <div key={tc.userId} className="flex items-center gap-4 border border-ga-line bg-ga-card px-[22px] py-5">
                    ...
                    <button type="button" onClick={() => toast('Phân công lớp (sắp ra mắt)')} className="ga-ui shrink-0 border border-ga-line px-3 py-2 text-[11.5px] font-semibold text-ga-muted transition-colors hover:border-ga-accent hover:text-ga-accent">
                      Phân công
                    </button>
                  </div>
                ))}
