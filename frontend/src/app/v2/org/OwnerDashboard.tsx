...
// (ghế, token pool, phân bố CEFR, doanh số chỗ ngồi). MANAGER (nhân sự) có bảng RIÊNG thiên về vận
// hành hằng ngày → ManagerDashboard.tsx; /v2/org (page.tsx) chọn bảng theo orgRole.
//
// Plumbing reused 1:1 (zero backend):
