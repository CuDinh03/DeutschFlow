...
const ROLE_LABEL: Record<RoleId, string> = { teacher: 'Giáo viên', admin: 'Admin', org: 'Tổ chức', student: 'Học viên' }
...
export function GaSidebar({ nav }: GaSidebarProps) {
  ...
  return (
    <aside className="flex w-[248px] shrink-0 flex-col border-r border-ga-line bg-ga-card p-5">
      ...
      <nav className="flex-1 space-y-5 overflow-y-auto" aria-label="Điều hướng chính">
