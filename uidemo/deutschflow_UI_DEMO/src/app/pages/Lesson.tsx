...
export default function Lesson() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-hidden pb-20">
      {/* ── Top Bar ─────────────────────────────────────────────────────────── */}
      <header className="flex items-center gap-3 px-4 py-3 border-b border-[#F0F4F8] flex-shrink-0">
        ...
        <div className="flex-1 flex flex-col gap-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-[#00305E] text-[10px] font-semibold">
        ...
        {/* Streak */}
        <div className="flex items-center gap-1 bg-[#FFF8E1] rounded-[10px] px-2 py-1.5 border border-[#FFCE00]/30 flex-shrink-0">
