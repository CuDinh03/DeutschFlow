  ...
  return (
    <motion.button
      ...
      style={{
        background: isSelected
          ? `linear-gradient(180deg, ${persona.bg} 0%, rgba(15, 15, 15, 0.92) 100%)`
          : "rgba(26, 26, 26, 0.9)",
        border: `2px solid ${isSelected ? persona.accent : "rgba(255, 255, 255, 0.1)"}`,
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(0deg, rgba(15, 15, 15, 0.95) 60%, rgba(15, 15, 15, 0))",
        }}
      >
        {/* Tag pill */}
        <span
