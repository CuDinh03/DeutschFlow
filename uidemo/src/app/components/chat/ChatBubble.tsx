// ─────────────────────────────────────────────────────────────────────────────
// DeutschFlow · ChatBubble
// Master component for all message variants in the AI Chat screen.
//
// Variants:
//   "user"      — Right-aligned, navy gradient
//   "ai"        — Left-aligned, persona-colored dark bg
//   "streaming" — Left-aligned, ai bubble with typewriter cursor (latest AI msg)
//   "error"     — Left-aligned, destructive red tint, retry icon
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "linear-gradient(135deg, var(--bauhaus-black), var(--bauhaus-red))" }}
      >
        {text}
      </div>
    </motion.div>
...
function ErrorBubble({ onRetry }: ErrorBubbleProps) {
  return (
    ...
    >
      ...
      >
        <AlertTriangle size={15} className="flex-shrink-0 mt-0.5" style={{ color: "var(--bauhaus-red)" }} />
...
export function ChatBubble({
  ...
  bubbleBg = "rgba(0, 0, 0, 0.05)",
  border = "rgba(218, 41, 28, 0.25)",
