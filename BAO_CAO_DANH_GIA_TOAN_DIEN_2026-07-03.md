...
> ✅ **ĐANG XỬ LÝ (2026-07-14):** phát hiện này là nguồn của kế hoạch `plans/2026-07-14-xoa-sach-v1-web.md` — đã bịt mọi đường vào v1, port ~22 tính năng còn kẹt sang v2, backend chỉ phát path v2 (đợt 0-2.6, PR #219-#222). Cây v1 sẽ được xoá ở đợt 3 sau khi deploy+QA. Kill-switch `GALERIE_V2_DISABLED` nhắc bên dưới đã bị gỡ.
