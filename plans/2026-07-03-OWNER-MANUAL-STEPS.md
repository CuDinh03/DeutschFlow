...
- [ ] Pricing `https://mydeutschflow.com/v2/payment` → chỉ FREE + PRO (coming soon), không còn ULTRA/MoMo/Stripe. *(Route cũ `/student/pricing` thuộc cây v1 — **đã gỡ hẳn 02/09/2026**, nay là redirect 308 sang `/v2/payment`; xem `plans/2026-07-14-xoa-sach-v1-web.md`.)*
