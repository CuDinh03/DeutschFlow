...
| P3 | Calibration (F1) + flip model | 🔄 **F2.4 + F1.1 XONG**: script contract-test (8/8 tier đạt trên Fireworks thật) + harness đo được "mất nhận xét"/cost/ngân sách. 🔴 **Đo lòi ra: CẢ 3 ứng viên F1 không chạy nổi ở ngân sách token hiện tại** ⇒ flip KHÔNG còn là "sửa 1 dòng env"; phát sinh F1.0 + tiền đề F3.4. CÒN: F1.2–F1.5 (cần DB prod + deploy). Số đo: `BAO_CAO_CONTRACT_TEST_TIER_2026-08-09.md` | [#312](https://github.com/CuDinh03/DeutschFlow/pull/312) · [#313](https://github.com/CuDinh03/DeutschFlow/pull/313) · [#314](https://github.com/CuDinh03/DeutschFlow/pull/314) | — |
