...
> Host this document at a public URL and paste that URL into App Store Connect (App Information → EULA) if you provide custom terms. You may also rely on Apple's [Standard EULA](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/). DeutschFlow is **free with no in-app purchases and no subscriptions** in this version.
...
DeutschFlow is **free to download and use**. Some advanced features (such as AI speaking practice) may be offered on a **time-limited free trial** or reserved for a future premium plan. Free trials involve **no payment**, are provided at our discretion, and may change, be limited, or end at any time. **This version of the App contains no in-app purchases and no subscriptions.**
...
DeutschFlow **miễn phí tải và sử dụng**. Một số tính năng nâng cao (như luyện nói với AI) có thể được cung cấp dưới dạng **dùng thử miễn phí có thời hạn** hoặc dành cho gói cao cấp trong tương lai. Dùng thử miễn phí **không phát sinh thanh toán**, được cung cấp theo quyết định của chúng tôi, và có thể thay đổi, bị giới hạn hoặc kết thúc bất cứ lúc nào. **Phiên bản này của Ứng dụng không có mua hàng trong ứng dụng và không có gói đăng ký.**
