...
>
> ⚠️ **2026-07-14:** mọi nhắc tới rollback bằng `GALERIE_V2_DISABLED` trong file này đã **LỖI THỜI** — kill-switch bị gỡ khỏi middleware (đợt 0, `plans/2026-07-14-xoa-sach-v1-web.md`). Rollback = revert commit / Amplify "Redeploy this version".
>
