...
| 2026-06-21 | **W1.7** admin-12 (**6/12**) | ✅ classes · settings · marketing · analytics · **mock-exam-packs (CRUD)** · **weekly-speaking (CRUD)** + nav. tsc+eslint sạch. **Còn 6:** grammar-review(duyệt) · training-dataset · reports(+3 con). |
