...
| 2026-06-21 | **W1.7** admin-12 (**1/12**) | 🔧 Pattern-setter admin-LIST: `/v2/admin/classes` (GET `/api/admin/classes`: name/teacherName/studentCount) + đăng ký `adminNav`. tsc+eslint sạch. **Còn 11:** settings · marketing · mock-exam-packs · weekly-speaking · grammar-review · analytics · training-dataset · reports(+3 con). Build order: tĩnh/list trước → CRUD → hub reports. |
